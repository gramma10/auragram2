    ...
    <div className="relative min-h-screen text-white selection:bg-royal/30">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <motion.div
          ...
          className="absolute top-[10%] -right-20 w-[500px] h-[500px] bg-royal/[0.04] blur-[130px] rounded-full"
        />
        <motion.div
          animate={{
            y: [0, 40, 0],
          ...
          className="absolute bottom-[10%] -left-20 w-[600px] h-[600px] bg-royal/[0.02] blur-[160px] rounded-full"
        />
      </div>
