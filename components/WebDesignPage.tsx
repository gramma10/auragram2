...
/* ══════════════════════════════════════════════════════ */
const WebDesignPage: React.FC<WebDesignPageProps> = ({ lang, setLang, onStartProject }) => {
  ...
  const t = {
    en: {
      tag: 'Service',
      h1: <>High-Performance<br /><span className="text-royal">Web Design.</span></>,
      sub: "We engineer high-converting digital storefronts — not just beautiful websites. Premium UI/UX, sub-2-second load times, built to scale.",
      cta1: 'Book a Discovery Call',
      painTag: 'The Problem',
      painH: 'Slow, generic websites cost you clients.',
      painBody: "A template-based site signals mediocrity. High-ticket clients notice — and go elsewhere. Your digital presence should reflect the quality of your work.",
      solTag: 'What We Build',
      solH: 'Every pixel engineered with intent.',
      features: [
        { title: 'Custom UI/UX Design', desc: "Bespoke interfaces tailored to your audience's psychology — no templates, ever." },
        { title: 'Blazing Fast Speeds', desc: 'Sub-2-second load times. Low bounce rates. Higher conversions. Always.' },
        { title: 'SEO & Conversion Optimized', desc: 'Clean code, technical SEO, and user journeys built to turn visitors into clients.' },
      ],
      ctaH: 'Ready to upgrade?',
      ctaSub: "Let's build a website that works as hard as you do.",
      ctaBtn: 'Start Your Project',
    },
    gr: {
      tag: 'Υπηρεσία',
      h1: <>Ιστοσελίδες<br /><span className="text-royal">Υψηλών Επιδόσεων.</span></>,
      sub: "Δεν φτιάχνουμε απλώς όμορφα sites. Σχεδιάζουμε ψηφιακές εμπειρίες με premium UI/UX και χρόνους φόρτωσης κάτω των 2 δευτερολέπτων.",
      cta1: 'Κλειστε ενα Discovery Call',
      painTag: 'Το Πρόβλημα',
      painH: 'Αργές ιστοσελίδες κοστίζουν πελάτες.',
      painBody: "Ένα template-based site μεταδίδει μετριότητα. Οι premium πελάτες το αντιλαμβάνονται — και πηγαίνουν αλλού. Η ψηφιακή σας παρουσία πρέπει να αντικατοπτρίζει την ποιότητά σας.",
      solTag: 'Τι Χτίζουμε',
      solH: 'Κάθε pixel, σχεδιασμένο με πρόθεση.',
      features: [
        { title: 'Custom UI/UX Design', desc: 'Εξατομικευμένα interfaces, προσαρμοσμένα στην ψυχολογία του κοινού σας. Μηδέν templates.' },
        { title: 'Ασύγκριτες Ταχύτητες', desc: 'Χρόνοι φόρτωσης κάτω από 2 δευτερόλεπτα. Χαμηλό bounce rate. Υψηλά conversions.' },
        { title: 'SEO & Conversions', desc: 'Καθαρός κώδικας, τεχνικές SEO και user journeys που μετατρέπουν επισκέπτες σε πελάτες.' },
      ],
      ctaH: 'Έτοιμοι να αναβαθμίσετε;',
      ctaSub: "Ας χτίσουμε μαζί μια ιστοσελίδα που δουλεύει τόσο σκληρά όσο εσείς.",
  ...
  const featureIcons = [
    ...
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" /></svg>,
  ...
  return (
    <div className="relative min-h-screen text-white selection:bg-royal/30">
      ...
      {/* Floating Decorative Elements - Simplified for Mobile Performance */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <motion.div
          ...
          className="absolute top-[20%] -left-20 w-96 h-96 bg-royal/5 blur-[120px] rounded-full hidden md:block"
        />
        <motion.div
          animate={{
            y: [0, 30, 0],
          ...
          className="absolute bottom-[20%] -right-20 w-[500px] h-[500px] bg-royal/[0.03] blur-[150px] rounded-full hidden md:block"
        />
      </div>
      ...
      <main className="relative z-10">
        ...
        <section className="py-24 md:py-32 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="absolute -top-16 -right-16 w-48 h-48 bg-royal/[0.07] blur-[80px] rounded-full pointer-events-none" />
